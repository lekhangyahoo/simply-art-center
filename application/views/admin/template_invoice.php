...
<page size="A4">
     <div style="font-size:12px; font-family:verdana, sans-serif; min-height:495px; margin-top:10px">
         ...
         <h2 class="bill-order">BIÊN NHẬN THU TIỀN</h2>
         <div class="center">
             Số: <?php echo $invoice_number;?>
         </div>
         <div>
             <?php foreach($detail_invoice as $item){?>
                 <p>
                     Tên học viên: <b><?php echo strtoupper($item->student_name);?></b>
                 </p>
                 <p>
                     Tên phụ huynh: <b><?php echo strtoupper($item->parent_name);?></b>
                 </p>
                 <p>
                     Điện thoại: <b><?php echo $item->phone;?></b>
                 </p>
                 <p>
                     Email: <b><?php echo $item->email;?></b>
                 </p>
             <?php break;}?>
         </div>
