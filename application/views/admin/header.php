...
<script type="text/javascript" src="<?php echo base_url('assets/js/simply_art.js');?>"></script>
...
<body>
<?php if($this->auth->is_logged_in(false, false))://pr($this->auth->menu_header);?>
<div class="navbar navbar-fixed-top">
    <div class="navbar-inner">
        <div class="container">
            ...
            <a class="brand" href="<?php echo $admin_url;?>">Simply-Art.com</a>
            
            <div class="nav-collapse">
                <ul class="nav">
                    <?php foreach($this->auth->menu_header as $menu){?>
                        <?php if(empty($menu->chilren_menu) && $menu->url != ''){?>
                            <li><a href="<?php echo trim('/', $admin_url.$menu->url);?>"><?php echo $menu->name;?></a></li>
                        <?php }else{?>
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo $menu->name;?> <b class="caret"></b></a>
                                    <?php if(!empty($menu->chilren_menu)){?>
                                        <ul class="dropdown-menu">
                                            <?php foreach($menu->chilren_menu as $children){?>
                                                <li><a href="<?php echo $admin_url.$children->url;?>"><?php echo $children->name;?></a></li>
                                            <?php }?>
                                        </ul>
                                    <?php }?>
                                </li>
